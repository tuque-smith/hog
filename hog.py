...
def is_swap(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4
    def diff_compute(score):
        # only look at last 2 digits
        score %= 100
        if (score < 10):
            return score
        ones = score % 10
    ...
    player_diff = diff_compute(player_score)
    opponent_diff = diff_compute(opponent_score)
